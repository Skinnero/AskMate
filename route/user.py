...
count_question_answer_comment_by_user
...
def user():
    ...
    users_count = count_question_answer_comment_by_user()
...
def user_profile(user_id):
    ...
    users_count = count_question_answer_comment_by_user(f"WHERE users.id = '{user_id}'")[0]
    print(users_count)
