...
from os import path
from util import get_data_by_id, prepare_answer_before_saving
from connection import ANSWER, QUESTION, IMAGE_DATA
from data_handler import read_all_data_from_db, insert_data_into_db, delete_data_in_db, update_data_in_db
...
def route_delete_answer(answer_id):
    data = get_data_by_id(answer_id,read_all_data_from_db(ANSWER))
