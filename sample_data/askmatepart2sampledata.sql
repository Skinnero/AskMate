...
ALTER TABLE IF EXISTS ONLY public.answer DROP CONSTRAINT IF EXISTS fk_asnwer_user_id CASCADE;
...
ALTER TABLE ONLY answer
    ADD CONSTRAINT fk_asnwer_user_id FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE;
